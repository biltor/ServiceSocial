...
protected function afterCreate(): void
{
    ...
    // 2️Créer le contrat uniquement si aucun contrat n'existe pour ce crédit
    ...
    \App\Models\mouvementBanque::create([
        'reference' => 'CR-' . $credit->id,
        'type' => 'debit', 
        'amount' => $credit->amount_accord,
        'description' => 'Crédit accordé à ' . $credit->employee->name .' '.$credit->employee->last_name,
        'date' => now(),
        'credit_social_id' => $credit->id,
    ]);
